...
cd /root/ClinicalXgboost/mysql
mkdir output-20240927
sqlite3 -header -csv db/urticaria.db < SQLquery/sql/dataforxgboost_timeseries_2024-09-27.sql > output-20240927/dataforxgboost_timeseries_2024-09-27.csv